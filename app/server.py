...
from config import load_config, ArkConfig
...
def main():
    ...
    parser.add_argument("--port", type=int, default=5000, help="Localhost port to listen on")
    ...
    try:
        ...
        uvicorn.run(mcp.streamable_http_app, host="0.0.0.0", port=args.port, factory=True)
